      ...
      <header>
        ...
        <nav class={openMenu(menu)}>
          ...
          <ul class="mobile-menu-category-list">
            ...
            <li class="menu-category">
              <button
                class={subCategory ? "accordion-menu active" : "accordion-menu"}
                onClick={() => {
            ...
            <li class="menu-category">
              <button
                class={
                  subCategory2 ? "accordion-menu active" : "accordion-menu"
                }
                onClick={() => {
            ...
            <li class="menu-category">
              <button
                class={
                  subCategory3 ? "accordion-menu active" : "accordion-menu"
                }
                onClick={() => {
          ...
          <div class="menu-bottom">
            <ul class="menu-category-list">
              ...
              <li class="menu-category">
                <button
                  class={
                    sideBarCurrency ? "accordion-menu active" : "accordion-menu"
                  }
                  onClick={() => {
